  ...
  if (myKLTN.length > 0) {
    ...
    if (isSubmittedKLTN && !isEditingKLTN) {
      ...
      html += `<div class="card"><div class="card-title" style="margin-bottom:16px">📤 Nộp bài KLTN</div>
        ...
        <button class="btn btn-secondary" style="margin-top:12px;width:100%" onclick="toggleKLTNEditMode('${k.id}')">✏️ Chỉnh sửa bài</button>` : `<button class="btn btn-secondary" style="width:100%" onclick="toggleKLTNEditMode('${k.id}')">✏️ Chỉnh sửa bài</button>`}
      </div>`;
    }
